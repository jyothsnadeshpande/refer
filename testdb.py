...
def select_col(dir = 'tarantino',year = 1994, actor = 'brad pitt' ):
	conn, c = connect()
	c.execute("select name from mo where director = {d} and release_year = {y} and cast_1 = {a} or cast_2 = {a} or cast_3 = {a} or cast_4 = {a} or cast_5 = {a} or cast_6 = {a} ".ormat( d = dir, y = year,a = actor))
